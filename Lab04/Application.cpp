...
int Application::GetCommand()
{
    ...
    while (1) {
        ...
        cout << "\t|" << left << setw(WIDTH) << setfill(' ') << "  8: Retrieve by Resident Number(BS)" << "|\n";
...
bool Application::RetrieveProductByCode()
{
    ...
    m_List.ResetList();		// m_pointercur = -1; �� ����
//	int length = m_List.GetLength(); // ���� �Ⱦ��ϱ� �ϴ� �ּ�..!
...
*	@return	return true if this function works well, otherwise false.
*/
bool Application::RetrieveProductByCodeUsingBS()
{
    if (m_List.isEmpty()) // If list is empty, show below error
    {
        cout << "\t [!] There's no data to show" << endl;
...
//	int length = m_List.GetLength(); // ���� �Ⱦ��ϱ� �ϴ� �ּ�..!
    ...
    int index = m_List.Retrieve_Binary(item);
...
bool Application::AddProductToBasket()
{
    m_List.ResetList();
    ItemType item;
    item.SetCodeNumFromKB();
...
//	bool Application::AddProductToBasket()
//	{
//		if (basket.IsFull()) // Check list is full
//		{
//			cout << "\n\t [!] List is Full" << endl;
//			return false;
//		}
...
//	*	@post	none
//	*/
//	bool Application::DisplayProductsInBasket()
//	{
//		cout << "\t-------------- All records --------------" << "-\n";
//
